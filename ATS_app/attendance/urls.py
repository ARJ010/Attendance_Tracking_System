...
urlpatterns = [
    ...
    path("transfer/<int:student_id>/",views.create_transfer, name="create_transfer"),
    path("api/programmes/<int:dept_id>/", views.get_programmes_by_department, name="get_programmes_by_department"),
    ...
    path('teachers/toggle_active/<int:teacher_id>/', views.toggle_teacher_active, name='toggle_teacher_active'),
    ...
    path('student/<int:student_id>/grace/', views.manage_grace_attendance, name='manage_grace_attendance'),
    ...
    path('admin-department/toggle-hod/<int:teacher_id>/', views.admin_toggle_hod, name='admin_toggle_hod'),
    path('admin-department/bulk-deactivate-batches/', views.admin_bulk_deactivate_batches, name='admin_bulk_deactivate_batches'),
]
